                                                          ...
                                                          var i,j;
                                                             for( i=0;i<listing.length;i++){
                                                                    ...
                                                                    if(veg_type.length<1){
                                                                        ...
                                                                        veg_type.push({'veg_type':listing[i].food_type});
        ...
        for(var i=0;i<len;i++){
            ...
            if(req.body[i].category_name){
                      ...
                      var tt=_.filter(value, function(data) { 
                       ...
                       return _.some(data.cuisine_list, {category_name: req.body[i].category_name,'status':'true'});
             ...
             if(req.body[i].group_attr){
                 ...
                 if(filtered_data!=""){
                        ...
                        return _.some(data.occassion_list, {group_attr: req.body[i].group_attr,'status':'true'});
                 ...
                 //  console.log(filtered_data);
                   console.log(req.body[i].veg_type);
                       if(filtered_data!=""){
                                ...
                                var tt=_.filter(filtered_data,  { 'food_type': req.body[i].veg_type });
                      ...
                      filtered_data=[];
                       ...
                       var tt=_.filter(value,  { 'food_type': req.body[i].veg_type });
             //        console.log(tt);
                        for(j=0;j<tt.length;j++){
                             var count =0;
